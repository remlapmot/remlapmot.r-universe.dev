...
To add/remove packages please either use the justfile `add`/`remove` recipes (requires that [`just`](https://just.systems/) and [`uv`](https://docs.astral.sh/uv/getting-started/installation/) are installed) or edit _packages.json_ manually.
